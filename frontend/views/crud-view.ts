...
import '@vaadin/grid';
import { Grid, GridActiveItemChangedEvent, GridDataProviderCallback, GridDataProviderParams, GridSelectedItemsChangedEvent } from "@vaadin/grid";
...
export class CrudView extends LitElement {
  ...
  render() {
    return html`
    <vaadin-grid .dataProvider=${this.getGridData} @active-item-changed=${makeGridSingleSelect} @selected-items-changed=${this.itemSelected}>
