...
export class TestView extends LitElement {
  ...
  async connectedCallback() {
    ...
    HelloEndpoint.countToAndFail(10, 200)
      .onNext((value) => {
        this.number3 = value;
      })
      .onComplete(() => {
  ...
  render() {
    return html`
      ...
      <p>
        Count quickly to 10 but fail:
        ${this.number3}${this.count3Done ? html` (done)` : nothing}${this.count3Error ? html` (failed)` : nothing}
      </p>
    `;
  }
}
